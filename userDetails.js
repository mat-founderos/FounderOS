document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("https://ipinfo.io/json")
        ...
        .then(data => {
            ...
            const countryFullName = userCountry ? userCountry.name : "Country Not Found";
            ...
            if (selector) {
                countries.sort((a, b) => a.name.localeCompare(b.name)).forEach(country => {
                    ...
                    if (country.name === countryFullName) {
            ...
            // Set hidden fields
            const ipField = document.querySelector("#ip-address");
            if (ipField) ipField.value = data.ip || "IP Not Found";

            const countryField = document.querySelector("#country");
            if (countryField) countryField.value = countryFullName;
        })
